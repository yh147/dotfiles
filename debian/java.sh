...
java_url="http://google.yangyaqi.cn/jdk-8u212-linux-x64.tar.gz"

function install_jdk() {
	if [ $first == "install8" ]; then
		wget $java_url
		tar -zxvf jdk-8u212-linux-x64.tar.gz -C /home/
		rm -rf jdk-8u212-linux-x64.tar.gz
		echo export JAVA_HOME=/home/jdk1.8.0_212 >> ~/.bash_profile
